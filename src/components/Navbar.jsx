...
import { MessageSquare, Settings, User, LogOut } from 'lucide-react'; // ✅ Icon imports
      ...
      <div className="container mx-auto px-4 h-16">
        <div className="flex items-center justify-between h-full">
          ...
          <div className='flex items-center gap-8'>
            <Link to="/" className="flex items-center gap-2.5 hover:backdrop-opacity-80 transition-all">
